...
from Scraper.Selenium_scraper.selenium_config import PATTERN_BROAD_TEXT, PATTERN_LINK_TEXT, PATTERN_HEADLINE_TEXT
...
def collect_liks_v2(driver, element_class):
    try:
        links = []
